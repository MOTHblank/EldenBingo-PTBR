...
namespace EldenBingoCommon
{
    public static class LocalizationManager
    {
        ...
        private static readonly Dictionary<string, string> PtBrStrings = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "Create Lobby", "Criar Sala" },
            { "Join Lobby", "Entrar na Sala" },
            { "Leave Lobby", "Sair da Sala" },
            { "Change Team", "Mudar de Equipe" },
            { "Open Map", "Abrir Mapa" },
            { "Pop-Out Board", "Abrir Cartela em Janela Separada" },
            ...
            { "Admin password (optional):", "Senha de administrador (opcional):" },
            { "Nickname:", "Apelido:" },
            { "Team:", "Equipe:" },
            { "Lobby Settings <<", "Configurações da Sala <<" },
            { "Lobby Settings >>", "Configurações da Sala >>" },
            { "Seed: ", "Semente: " },
            ...
            { "Browse", "Procurar" },
            { "Upload", "Enviar" },
            { "Randomize New Board", "Gerar Nova Cartela" },
            { "Start Match", "Iniciar Partida" },
            { "Pause Match", "Pausar Partida" },
            { "Unpause Match", "Retomar Partida" },
            { "Stop Match", "Parar Partida" },
            { "Admin Controls", "Controles do Administrador" },
            { "Edit Lobby Settings", "Editar Configurações da Sala" },
            ...
            { "Bingo Board Max Size", "Tamanho Máximo da Cartela" },
            ...
            { "Highlight Marked Squares", "Destacar Casas Marcadas" },
            { "Highlight Bingo Lines", "Destacar Linhas de Bingo" },
            { "Keyword Colors", "Cores por Palavra-chave" },
            { "Edit...", "Editar..." },
            { "Apply colors suggested by board", "Aplicar cores sugeridas pela cartela" },
            ...
            { "Bingo Board Hotkeys", "Atalhos da Cartela de Bingo" },
            { "↑ Up", "↑ Cima" },
            { "↓ Down", "↓ Baixo" },
            { "← Left", "← Esquerda" },
            { "→ Right", "→ Direita" },
            ...
            { "✔️ Mark Square", "✔️ Marcar Casa" },
            { "⭐ Star Square", "⭐ Marcar Casa com Estrela" },
            { "➕ Increment Count", "➕ Aumentar Contador" },
            { "➖ Decrement Count", "➖ Diminuir Contador" },
            ...
            { "Note: Mouse wheel is always bound to increment and decrement the counter for the hovered square", "Nota: A roda do mouse sempre aumenta e diminui o contador da casa sob o cursor" },
